...
class S3BucketProtocol(Protocol):
    ...
    def upload_file(
        self, filename: str | Path, key: str, **kwargs
    ) -> dict[str, Any]: ...

    def upload_fileobj(
        self, fileobj: BinaryIO, key: str, **kwargs
    ) -> dict[str, Any]: ...

    def download_file(self, key: str, filename: str | Path, **kwargs) -> None: ...

    def download_fileobj(self, key: str, fileobj: BinaryIO) -> None: ...

    def get_object(self, key: str, **kwargs): ...

    def list_objects(self, prefix: str = "", **kwargs) -> dict[str, Any]: ...
...
class MockBucket(S3BucketProtocol):
    ...
    def upload_file(self, filename: str | Path, key: str) -> dict[str, Any]:
        try:
    ...
    def download_file(self, key: str, filename: str | Path) -> None:
        try:
